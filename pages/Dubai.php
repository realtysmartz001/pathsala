                ...
                <div class="hero__caption hero__caption2">
                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="Dubai.html">Danube Properties</a></li>
                    </ol>
                  </nav>
                  <!-- breadcrumb End -->
                </div>
            ...
            <div class="blog_left_sidebar">
              <article class="blog_item">
                <div class="blog_item_img">
                  <img class="card-img rounded-0" src="/assets/img/gallery/topic6.png" alt="">
                ...
                <div class="blog_details">
                  <a class="d-inline-block" href="blog_details.html">
                    <h2 class="blog-head" style="color: #2d2d2d;">Danube Properties</h2>
                  </a>
                  <p>Danube Properties in Dubai offers luxurious, affordable homes with world-class
                    ...
                    smart real estate investments.</p>
